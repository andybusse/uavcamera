\section{Camera Module Testing - (mh23g08)}
...
\subsection{Test: Basic Connection Test on Arduino - (mh23g08)}
...
\subsection{Test: Image from Camera - (mh23g08)}
...
This test validates milestone \ref{sec:ms_img_cam_change_res}.
