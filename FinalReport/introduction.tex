...
\begin{figure}[H]
        \centering
        \includegraphics[width=1.00\textwidth]{figures/spec_block_diagram2.jpg}
        \captionof{figure}{Block diagram displaying how the separate parts 
of this project interact, and which parts of this project we need to 
implement.}
...
The cost and inflexibility of the existing solution \ref{sec:existing_soln} 
