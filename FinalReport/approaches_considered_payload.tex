\section{Payload Controller Hardware (mh)}
...
We chose to use an Atmel 8-bit AVR as the platform for our implementation of the payload controller with the use of the Arduino prototyping platform. Our main reason for choosing this platform is because we already have experience in using this microcontroller, meaning less time to develop and 
